...
function CartComponent({ openCart, onClose, cartItems }) {
    ...
    //     const product = cartItems.find(item=>item.idProduct === idProduct)
    ...
    //     const indexProduct = cartItems.findIndexOf(item=>item.idProduct === idProduct)//tìm vị trí phần tử muốn xoá
